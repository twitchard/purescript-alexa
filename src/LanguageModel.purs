...
newtype LanguageModel = LanguageModel
  { invocationName :: String
  , intents :: Array Intent
  , types :: Array SlotType
  }

derive instance newtypeLanguageModel :: Newtype LanguageModel _
derive instance eqLanguageModel :: Eq LanguageModel
derive instance gLanguageModel :: Generic LanguageModel _
instance showLanguageModel :: Show LanguageModel where show = genericShow
...
derive instance gIntent :: Generic Intent _
...
derive instance gSlot :: Generic Slot _
instance showSlot :: Show Slot where show = genericShow

newtype SlotType = SlotType
  { values :: Array SlotValue
  , name :: String
  }

derive instance newtypeSlotType :: Newtype SlotType _
derive instance eqSlotType :: Eq SlotType
derive instance gSlotType :: Generic SlotType _
instance showSlotType :: Show SlotType where show = genericShow

newtype SlotValue = SlotValue
  { name :: SlotValueName }

derive instance newtypeSlotValue :: Newtype SlotValue _
derive instance eqSlotValue :: Eq SlotValue
derive instance gSlotValue :: Generic SlotValue _
instance showSlotValue :: Show SlotValue where show = genericShow

newtype SlotValueName = SlotValueName
  { value :: String
  , synonyms :: Array String
  }

derive instance newtypeSlotValueName :: Newtype SlotValueName _
derive instance eqSlotValueName :: Eq SlotValueName
derive instance gSlotValueName :: Generic SlotValueName _
instance showSlotValueName :: Show SlotValueName where show = genericShow
